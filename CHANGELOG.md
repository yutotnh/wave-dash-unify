...
- 対応するVS Codeの最小バージョンを1.100.0から1.66.0に引き下げ、古いVS Codeでも最新版を利用できるようにしました。0.4.0([#517](https://github.com/yutotnh/wave-dash-unify/pull/517))で必要になっていた1.100.0以降という制限を解消するもので、1.100.0以降では引き続きVS CodeのAPIでEUC-JPを判定します。([#XXX](https://github.com/yutotnh/wave-dash-unify/pull/XXX))
